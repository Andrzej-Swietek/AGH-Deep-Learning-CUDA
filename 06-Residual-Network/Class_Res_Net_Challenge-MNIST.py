...
if __name__ == '__main__':
    ...
    for epoch in range(args.epochs):
        ...
        # You need to add code here: Compute and print image throughput (images per second) for each epoch.
        ...
        # You need to add code here: implement early stopping. Use the validation accuracy array (val_accuracy) 
