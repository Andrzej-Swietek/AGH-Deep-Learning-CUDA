# necessary imports - all should be included in our local colab exe env
import argparse
import torch
...
if __name__ == '__main__':
    ...
    # THIS IS THE LINE!! We are moving our model to the GPU for execution
    ...
    for epoch in range(args.epochs):
        ...
        # Make a change 3: Compute total training time. Outside of the epoch loop, initialize the 
        ...
        # Make a change 1: Compute and print image throughput (images per second) for each epoch.
        # Use the variable name images_per_sec to store the value. Note that within our train 
        # and test loader, we have set the parameter drop_last as True. What does it mean? 
        # To compute the throughput we need the number of batches per epoch. args.batch_size is the input
        ...
        # Make a change 2: implement early stopping. Use the validation accuracy array (val_accuracy) 
